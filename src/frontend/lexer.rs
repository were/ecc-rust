...
impl fmt::Display for TokenType {
  fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
    match self {
      ...
      TokenType::BitwiseXor => write!(f, "BitwiseXor ^"),
      TokenType::BitwiseShl => write!(f, "BitwiseShl <<"),
      TokenType::BitwiseShr => write!(f, "BitwiseShr >>"),
  ...
  pub fn new() -> Self {
    TokenHandle {
      handle: vec![
        ...
        (Regex::new(r"^!="), valueless_token!(TokenType::NE)),
        ...
        (Regex::new(r"^&"), valueless_token!(TokenType::BitwiseAnd)),
        (Regex::new(r"^\|"), valueless_token!(TokenType::BitwiseOr)),
        (Regex::new(r"^\^"), valueless_token!(TokenType::BitwiseXor)),
        (Regex::new(r"^<<"), valueless_token!(TokenType::BitwiseShl)),
        (Regex::new(r"^>>"), valueless_token!(TokenType::BitwiseShr)),
